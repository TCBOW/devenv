...
alias la='ls -A'
alias l='ls -CF'
alias vim='/home/tochibow9/git/devenv/tools/vim/bin/bin/vim'
...
# devenv additional discription
export PATH="$PATH:$HOME/git/devenv/scripts"
function ssh_set_bgcolor() {
    case $1 in
        tochibow9@192.168.122.227 ) echo -e "\033]1337;SetProfile=ubuntu18\a" ;;
    esac
...
go() {
    cd $(${HOME}/git/devenv/scripts/go/disp.pl $1)
    ls -F
}
sshgo() {
    ssh $(${HOME}/git/devenv/scripts/sshgo/disp.pl $1)
}
